...
const sandThemeDefinition: Theme = {
  ...
  moveHighlight: 'rgba(191, 131, 84, 0.55)',
  lastMove: 'rgba(245, 158, 11, 0.4)',
  premove: 'rgba(249, 115, 22, 0.35)',
  check: 'rgba(248, 113, 113, 0.6)',
  checkmate: 'rgba(220, 38, 38, 0.7)',
  stalemate: 'rgba(59, 130, 246, 0.4)',
...
const neonThemeDefinition: Theme = {
  ...
  moveHighlight: 'rgba(59, 130, 246, 0.6)',
  lastMove: 'rgba(168, 85, 247, 0.45)',
  premove: 'rgba(34, 211, 238, 0.35)',
  check: 'rgba(251, 113, 133, 0.6)',
  checkmate: 'rgba(244, 63, 94, 0.7)',
  stalemate: 'rgba(110, 231, 183, 0.45)',
