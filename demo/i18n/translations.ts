...
export const translations = {
  en: {
    ...
    'app.playgroundLinkTitle': 'Open the hosted playground in a new tab',
    'app.playgroundLinkText': '🧪 Playground',
    'app.puzzleModeLinkTitle': 'Open the Puzzle Mode demo',
    'app.puzzleModeLinkText': 'ð§© Puzzle Mode',
    'app.languageLabel': 'Language',
    'app.languageEnglish': 'English',
    'app.languageFrench': 'French',
    'app.puzzleModeHighlightTitle': 'Puzzle Mode',
    'app.puzzleModeHighlightDescription': 'Solve curated puzzles with guidance, progress tracking, and contextual hints before returning to the board.',
    'app.puzzleModeHighlightCta': 'Try Puzzle Mode',
  ...
  fr: {
    ...
    'app.themeCreatorLinkText': '🎨 Theme Creator',
    'app.playgroundLinkTitle': 'Ouvrir le playground h\u00E9berg\u00E9 dans un nouvel onglet',
    'app.playgroundLinkText': '🧪 Playground',
    'app.puzzleModeLinkTitle': 'Ouvrir la démo Puzzle Mode',
    'app.puzzleModeLinkText': 'ð§© Puzzle Mode',
    'app.languageLabel': 'Langue',
    'app.languageEnglish': 'Anglais',
    'app.languageFrench': 'Fran\u00E7ais',
    'app.puzzleModeHighlightTitle': 'Puzzle Mode',
    'app.puzzleModeHighlightDescription':
      'R\u00E9solvez des puzzles guid\u00E9s, suivez vos progr\u00E8s et profitez d\u2019indices contextuels avant de revenir au plateau.',
    'app.puzzleModeHighlightCta': 'D\u00E9couvrir Puzzle Mode',
    'app.themes.midnight': 'Midnight',
    'app.themes.classic': 'Classic',
    'common.white': 'Blancs',
    'common.black': 'Noirs',
