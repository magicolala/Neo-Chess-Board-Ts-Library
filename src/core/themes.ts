...
const normalizeTheme = (theme: Theme): Theme => {
  ...
  return {
    ...
    moveHighlight: theme.moveHighlight ?? theme.moveTo ?? base.moveHighlight,
    moveTo: theme.moveTo ?? theme.moveHighlight ?? base.moveTo,
    check: theme.check ?? base.check,
    checkmate: theme.checkmate ?? base.checkmate,
    stalemate: theme.stalemate ?? base.stalemate,
  };
};
